...
1. Packs live in `config/bloodrushwaypoints/waypoints/`, module config in `config/odin/addons/bloodrushwaypoints.json`.
...
5. `devMessage`/`modMessage` calls became `BrwMod.logger` / `BrwMod.chat`.
